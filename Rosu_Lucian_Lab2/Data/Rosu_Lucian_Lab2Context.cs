...
namespace Rosu_Lucian_Lab2.Data
{
    public class Rosu_Lucian_Lab2Context : DbContext
    {
        ...
        public DbSet<Rosu_Lucian_Lab2.Models.Publisher> Publisher { get; set; } = default!;
        public DbSet<Rosu_Lucian_Lab2.Models.Author> Authors { get; set; } = default!;
        public DbSet<Rosu_Lucian_Lab2.Models.Category> Category { get; set; } = default!;
    }
}
